...
describe 'job_control_driver' do
  ...
  context "rjn0001" do
    ...
    it "最初のリクエスト" do
      ...
      @jobnet.reload
      @jobnet.phase_key.should == :starting
      @jobnet.started_at.utc.iso8601.should == @now.utc.iso8601
    end

    context 'j11を実行' do
      it "成功した場合" do
        @jobnet.phase_key = :running
      ...
      it "失敗した場合" do
        ...
        @jobnet.finished_at.utc.iso8601.should == @now.utc.iso8601
      end
    end
